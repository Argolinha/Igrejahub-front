...
export default function Login() {
  ...
  const [email, setEmail] = useState('carlos@igrejahub.com')
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16 bg-white">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <div className="flex items-center justify-between mt-4 mb-6">
            ...
            <a href="#" className="text-sm font-semibold text-brand-700 hover:underline">Esqueci minha senha</a>
          </div>

          <Button type="submit" className="w-full" size="lg">Entrar na plataforma</Button>
          <Button type="button" variant="outline" className="w-full mt-3" size="lg">
